...
const Footer = async({lang}:{lang:string}) => {
  ...
  return (
    <div className='text-white py-10 px-5 md:pt-32 md:pb-10 text-xs 2xl:text-base flex flex-col items-center relative bg-darker-blue'>
        <div className='w-4/5 flex flex-col lg:flex-row gap-24'>
            <div className='w-2/3 flex flex-col lg:flex-row gap-10 xl:gap-24 mb-10'>
                {
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <div className='flex gap-3 items-center'>
                            <BsFillTelephoneFill className='text-white text-sm' />
                            <h3>{footer.telephone}</h3>
                        </div>
                        <div className='flex gap-3 items-center'>
                            <FaMobileButton className='text-white text-sm' />
