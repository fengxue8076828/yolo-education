...
const TeacherCard = (
  ...
  return (
    <div className='flex-1 my-5 h-[300px]'>
      <div className='group relative [perspective:50rem]'>
        <div className='w-full group-hover:[transform:rotateY(180deg)] transition-all duration-700  bg-white  [backface-visibility:hidden] rounded-xl h-[300px]'>
        ...
        <div className='[transform:rotateY(-180deg)] group-hover:[transform:rotateY(0deg)] transition-all duration-700  bg-middle-blue absolute top-0 w-full h-[300px] [backface-visibility:hidden] rounded-xl overflow-hidden p-5'>
